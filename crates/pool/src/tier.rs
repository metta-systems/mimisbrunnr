...
// 32 MiB — fits R1c-A3.2 layout (3 MiB of fixed-offset directory
// regions + 1 MiB legacy CBOR blob + 4 MiB tag bitmap area + 8 MiB
// forward-overflow area + comfort margin).
const FMT_INDEX_ZONE_SIZE: u64 = 32 * 1024 * 1024;
